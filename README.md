...
**版本 0.4.0-alpha** · 本機優先的檔案工具箱。把常用的圖片、PDF、文件、影音、文字、資料格式、ZIP、雜湊與小工具集中到一個介面，不用記命令列也能完成日常檔案處理。
...
| 文字 | Base64、URL、HTML、搜尋取代、行處理、統計、**離線繁簡** |
| ZIP / Hash | 建立 ZIP、檔案校驗 |
| 進階分片 | 切成 part 分片（需完整合併才能還原） |
| 小工具 | 顏色、UUID、QR Code |
